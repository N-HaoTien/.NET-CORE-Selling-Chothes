...
public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<Order>(entity => { entity.ToTable("Order"); entity.Property(e => e.Id).HasColumnName("OrderId"); entity.HasKey(p => p.Id); entity.Property(p => p.CreatedDate).HasDefaultValue(DateTime.Now); entity.Property(p => p.IsPayBill).HasDefaultValue(false); });
        ...
        builder.Entity<Size>(entity => { entity.ToTable("Size"); entity.Property(e => e.Id).HasColumnName("SizeId"); entity.HasKey(p => p.Id); entity.HasIndex(p => p.Name).IsUnique(); });
